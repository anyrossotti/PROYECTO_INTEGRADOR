      ...
      <ul>
        ...
        <li class="nav-item dropdown">
						<a class="nav-link dropdown-toggle" href="#" id="dropNavBar" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
							<img src="img/Perfil.jpg" width="40" style="border-radius: 50%; background-color: #ffffff; padding: 3px;">
						</a>
      ...
      <div class="item">
        <form class="formulario">
          <div>
            ...
            <input class="inputs" type="text" name="nombre" value="Maribel">
          </div>
          <div>
            <label for="">Apellido:</label>
            <input class="inputs" type="text" name="apellido" value="Claros">
          </div>
          <div>
          ...
          <div>
            ...
            <input class="inputs" type="email" name="email" value="email@example.com">
          </div>
          <div>
